...
$pack=packagesClass::getPackageData('1');
if($pack->meta_title!='')
  ...
  <tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="width:246px"><a href="<?php echo DEFAULT_URL; ?>"><img src="images/Zenspa_03.jpg" width="246" height="103" /></a></td>
...
<input type="hidden" name="hdname" value="Relax me">
                ...
                <td align="left" valign="top" style="padding-bottom:10px; padding-top:10px; padding-left:18px; padding-right:18px"><table width="100%" border="0" cellpadding="2" cellspacing="0">
												<tr>
													<td width="45%" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td align="right" valign="top"><strong>US Certified Mail - $8.50 </strong>
																	<input type="checkbox" name="certified" id="certified" value="1" /></td>
															</tr>
															<tr>
												...
												<tr>
													<td width="45%" height="87" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
																<td align="right" valign="top"><strong>Messenger Service - $12.50 </strong>
																	<input type="checkbox" name="Messenger" id="Messenger" value="1"/></td>
															</tr>
															<tr>
