...
{ 
  ...
  function getPackageData($id)
  {
	...
	$fieldnames=array('package_title'=>$title,'package_one'=>$for_one,'package_two'=>$for_two,'package_desc'=>$content,'status'=>$status,'meta_title'=>$meta_title,'meta_desc'=>$meta_desc,'meta_keywords'=>$meta_keywords);
