...
<div class="content">
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list">
          <thead>
			...
			<?php echo $all_pages->authorize_response;?>
...
$os = array("Body Massage", "Body Zen Stone Therapies", "Body Exfoliations", "Body Wraps","body Zen Sidnature Therapies","Facial Skin Therapies","Facial Skin Boosters","Facial Zen Signature Therapies","Face & Body Waxing","Hands & Feet Nail Care","Vip Spa Suites","Hair Care Hair Studio");
   ...
   <div class="box">
	...
	<table width="100%">
    <?php
	if($res->g_treatmenttype!=''){  $j=($allstates->c_id)-1; ?>
    <tr><td><b>Treatment Cagegory:</b></td><td><?=$os[$j]?></td></tr>
    <tr><td height="10px"></td></tr>
	<tr><td><b>Desired Treatment:</b></td><td><?=$allstates->t_title?></td></tr>
    <tr><td height="10px"></td></tr>
    <?php }else if($res->g_package!=''){?>
      <tr><td><b>Package:</b></td><td><?=$res->g_package?></td></tr>
    <tr><td height="10px"></td></tr>
    <?php } ?>
	<tr><td width="24%"><b>Price:</b></td><td width="76%">$<?=$res->g_price?></td></tr>
	<tr><td height="10px"></td></tr>
			    <tr>
                <td  valign="middle" height="25" class="cart"><b>
                State Tax:&nbsp;</b> </td>
                <td  valign="middle" class="cart" style="padding-right:10px;">
               $<?php   echo number_format($res->govt_tax, 2, '.', '');?>&nbsp;</td>
...
<tr>
	  <td><b>Buyer's Email:</b></td>
	  <td><?=$res->g_emailid ?></td></tr>
	<tr><td height="10px"></td></tr>
	
	<tr><td><b>Buyer's Telephone:</b></td><td><?=$res->buyer_phone?></td></tr>
	<tr><td height="10px"></td></tr>
	
	<tr><td><b>Gift Certificate's From Name:</b></td><td><?=$res->from_user?></td></tr>
	
	<tr><td height="10px"></td></tr>
	<tr><td><b>Gift Certificate Recipient Name:</b></td><td><?=$res->g_recepientname?></td></tr>
	<tr><td height="10px"></td></tr>
	<tr><td><b>Message:</b></td><td><?=$res->g_message?></td></tr>
	<tr><td height="10px"></td></tr>
	
	
	<?php /*?><tr><td><b>Buyer Message:</b></td><td><?=$res->buyermessage?></td></tr>
	...
	<tr><td height="10px"></td></tr>
	<tr><td><b>Next Day Delivery:</b></td><td>$<?=$res->is_nextday ?></td></tr>
	<tr><td height="10px"></td></tr>
