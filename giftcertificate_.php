  ...
  <tr>
			...
			<form action="" name="frm" method="post" onSubmit="return validate()">
			  ...
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
				...
				<table width="100%" border="0" cellpadding="3" cellspacing="0" bordercolor="#000000">
                    ...
                    <tr>
                      <td align="left" valign="middle" class="greentext">
					  <select name="package" id="package" onchange="filldata1(this.value);"  >
			   ...
			   <tr id="trTreatments_1" class="hide">
                <td align="left" valign="middle" class="bigtext"><span class="greentext">*</span>Treatments</td></tr>
				...
				<tr id="trTreatmentsPrice_2" class="hide"> 
					<td align="left" valign="middle"><div id="citydiv"><input name="g_price" type="text" class="form" id="g_price"   readonly=""/></div></td>
				</tr>      
			  ...
			  <table width="80%" border="0" cellpadding="2" cellspacing="0">
                <tr>
                    <td align="left" valign="middle" class="bigtext" ><font color="red">*</font>&nbsp;Buyer's Complete Name:</td></tr>
                  <tr>
                    ...
                    <tr>
                      <td align="left" valign="middle" class="greentext"><input name="emailid" type="text" class="form" id="emailid" /></td>
                         ...
                         <tr>
                    <td align="left" valign="middle" class="bigtext" ><font color="red">*</font>&nbsp;Buyer's Telephone:</td></tr>
                  <tr>
                    <td align="left" valign="top"><input name="buyerstelephone" type="text" class="form" id="buyerstelephone" /></td>
                  </tr>
                    <tr>
                    <td align="left" valign="middle" class="bigtext" ><font color="red">*</font>&nbsp;Gift Certificate's From Name:</td></tr>
                  <tr>
			    ...
			    <table width="100%" border="0" cellpadding="2" cellspacing="0" style="background-color:#FFFFFF">
                  <tr>
                    <td  align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top"><input type="checkbox" name="certified" id="certified" value="1" />Delivery by Certified Mail $7<br />
                  ...
                  <tr>
                    <td  height="87" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="left" valign="top"><input type="checkbox" name="Messenger" id="Messenger" value="1" />Delivery by Messenger $10 (Metropolitan Area Only)<br />
   ...
   <script>
			function validate()
			{
			 ...
			 <?php /*?>
			   else if(document.frm.other_message.value=='')
			  {
			     alert("Please enter your message");
				 document.frm.other_message.focus();
				 return false;
			  }<?php */?>
  ...
  if (radios[i].checked) {
   radios[i].checked=false;
			...
			function filldata(id)
			{
				...
				country_sel('treatment',id,'showstate','statediv');
			}
			...
			function onTreatmentChange() {
				...
				alert(document.getElementById('treatmenttype').selectedIndex);
