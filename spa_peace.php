...
$pack=packagesClass::getPackageData('5');
if($pack->meta_title!='')
$metatitle=$pack->meta_title;
else
$metatitle="ZEN SPA RETREAT::Spa peace Package";
...
<input type="hidden" name="hdname" value="Spa Peace">
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="top">
				  <span class="bigtext">Package</span><br />
                  <span class="greentext"><?=$pack->package_title?></span>
				</td>
              </tr>
              ...
              <tr>
                <td align="left" valign="top" style="padding-top:10px; padding-bottom:10px"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="10%" align="left" valign="top" class="bigtext">Price</td>
                    <td width="50%" align="left" valign="top" class="bigtext">&nbsp; </td>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left" valign="middle" class="orangetext">&nbsp;</td>
                      </tr>
                    </table></td>
			  ...
			  <?php /*?><?php if($pack->package_desc !='') { ?>
              <tr>
                <td width="10%" align="left" valign="top" class="bigtext">Description</td>
              </tr>  
              <tr>
                <td width="10%" align="left" valign="top" class="bigtext"><span class="greentext"><?=$pack->package_desc?></span></td>
              </tr>
			  <?php } ?><?php */?>
              <tr>
                ...
                <td align="left" valign="top" style="padding-bottom:10px; padding-top:10px; padding-left:18px; padding-right:18px"><table width="100%" border="0" cellpadding="2" cellspacing="0">
                  <tr>
                    <td width="45%" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="right" valign="top"><input type="checkbox" name="certified" id="certified" value="1"/></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">Delivery by Certified Mail $7<br />
                  ...
                  <tr>
                    <td width="45%" height="87" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="right" valign="top"><input type="checkbox" name="Messenger" id="Messenger" value="1"/></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top">Delivery by Messenger $10 (Metropolitan Area Only)<br />
