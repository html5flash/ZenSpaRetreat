...
//print_r($post_values);
	...
	if($response_array[0]==1){
		 ...
		 $sql="INSERT INTO tb_order(order_number,order_packagename,order_price,order_for,order_otherprice,order_otherpackages,fullname,from_user,buyer_name,buyer_phone,	buyer_emailid,buyermessage,pickup_location,is_certified,cretified_mesage,is_messanger,messager_msg,is_nextday,nextday_msg)
SELECT order_number,order_packagename,order_price,order_for,order_otherprice,order_otherpackages,fullname,from_user,buyer_name,buyer_phone,	buyer_emailid,buyermessage,pickup_location,is_certified,cretified_mesage,is_messanger,messager_msg,is_nextday,nextday_msg from tb_temp where order_id='".$_SESSION['oid']."'";
		 $res=orderClass::UpdateOrderlist($sql);
		 
 	     $sql1="update tb_order set payment_status='1',authorize_response='" . addslashes($post_response) . "' where order_id ='" .$res['LASTID'] . "'";
		$res1=orderClass::UpdateOrderlist($sql1);
      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="98%" border="1" cellspacing="3" bordercolor="#000000" cellpadding="0" style="border-collapse: collapse">
           ...
           <?=$res->order_packagename?>
			  ...
			  <?php }} ?>
               ...
               $<?=number_format($total+$dis_total, 2, '.', '')?></b>&nbsp;</td>
                ...
                State Tax:&nbsp;</b> </td>
                <td align="right" valign="middle" class="cart" style="padding-right:10px;"><b>
               $<?php  $govt=(number_format($total, 2, '.', '')*$rs_set->govt_tax)/100;   echo number_format($govt, 2, '.', '');?></b>&nbsp;</td>
              </tr>
			    <tr>
                <td colspan="3" align="right" valign="middle" height="25" class="cart"><b>
                Municipal Tax:&nbsp;</b> </td>
                <td align="right" valign="middle" class="cart" style="padding-right:10px;"><b>
               $<?php  $local=(number_format($total, 2, '.', '')*$rs_set->local_tax)/100;
			   echo number_format($local, 2, '.', '');
			   ?></b>&nbsp;</td>
              </tr>
			  <tr>
                <td colspan="3" align="right" valign="middle" height="25" class="cart"><b>
                Grand Total:&nbsp;</b> </td>
                <td align="right" valign="middle" class="cart" style="padding-right:10px;"><b>
               $<?=number_format($total+$local+$govt, 2, '.', '')?></b>&nbsp;</td>
              </tr>
			...
			<table width="100%"><tr><td width="70%" >
					...
					<input type="hidden" name="ordertotal" value="<?php echo number_format($total+$local+$govt, 2, '.', '');?>">
					...
					<input type="hidden" name="orderid" value="<?php echo $res->order_number; ?>">
